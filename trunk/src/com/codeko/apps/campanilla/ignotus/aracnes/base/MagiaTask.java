...
public class MagiaTask extends org.jdesktop.application.Task<ResultadoMagia, Void> {
    ...
    private String[] getAranas() {
        String[] sA = new String[]{
            "com.codeko.apps.campanilla.ignotus.aracnes.aranas.MagiaMCU",
            "com.codeko.apps.campanilla.ignotus.aracnes.aranas.MagiaGoogleBooks",
            "com.codeko.apps.campanilla.ignotus.aracnes.aranas.MagiaWorldCat"
        };
